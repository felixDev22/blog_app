...
RSpec.describe Comment, type: :model do
  describe '#update_comments_counter' do
    ...
    let!(:post) { Post.create(author: user1, title: 'Hello', text: 'This is my first post', likes_counter: 5, comments_counter: 5) }
    let!(:comment) { Comment.create(user_id: user1.id, post_id: post.id, text: 'Hi Tom!') }
